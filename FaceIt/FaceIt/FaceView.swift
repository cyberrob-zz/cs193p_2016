...
class FaceView: UIView
{
    ...
    @IBInspectable
    var eyeBrowTilt: Double = -0.5 { didSet { setNeedsDisplay() }} // 1 full relaxed, -1 full furrow
    @IBInspectable
    ...
    private func pathForMouth() -> UIBezierPath
    {
        ...
        let cp2 = CGPoint(x: mouthRect.maxX - mouthRect.width / 3, y: mouthRect.maxY + smileOffset)
